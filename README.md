...
**Spring Boot Starter for icepdf**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/icepdf-spring-boot-starter)](https://github.com/easy-4-java/icepdf-spring-boot-starter)
...
> **Artifact ID**：`icepdf-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**icepdf-spring-boot-starter** is a Spring Boot starter that integrates **icepdf** for applications using icepdf. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume icepdf capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using icepdf |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for icepdf |
| JDK | `17` |
| Coordinates | `io.github.easy4j:icepdf-spring-boot-starter:2.7.x.20260527-SNAPSHOT` |
| Config Prefix | `icepdf` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers icepdf beans automatically |
| Property Binding | ✅ Stable | Binds `icepdf.*` to `Properties` |
...
|---|---|---|:---:|---|:---:|
| `icepdf.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl icepdf-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `icepdf.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/icepdf-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/icepdf-spring-boot-starter)
